...
$isHideBlockComments = COption::GetOptionInt('main', 'COMMENTS_HIDE_BLOCK');
?>
        ...
        <div class="row blog-entries">
            ...
            if (!$isHideBlockComments) {
                $APPLICATION->IncludeComponent('robotics:form', '', [
                    ...
                    'FIELD_ATR_NAMES' => 'name, city, avatar, message',
                    'FIELD_SEND' => 'NAME, PROPERTY_CITY, DETAIL_PICTURE, DETAIL_TEXT',
